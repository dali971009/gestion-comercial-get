enum RouteNames {
  ...
  PRODUCTION_REPORT_LIST = 'PRODUCTION_REPORT_LIST',
  PRODUCTION_REPORT_NEW = 'PRODUCTION_REPORT_NEW',
  PRODUCTION_REPORT_EDIT = 'PRODUCTION_REPORT_EDIT',
  PRODUCTION_REPORT_PRINT = 'PRODUCTION_REPORT_PRINT',
