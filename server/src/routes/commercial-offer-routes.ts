...
router.post('/', commercialOfferValidator.createCommercialOfferValidator, commercialOfferController.createCommercialOffer);
router.put('/', commercialOfferValidator.updateCommercialOfferValidator, commercialOfferController.updateCommercialOffer);
